...
.EXAMPLE
    ...
    Get-DDAlert  -DDfqdn "ddve-01.vlab.local" -DDAuthTokenValue $DD_Token -activealert -epochtime

    Get-DDAlert  -DDfqdn "ddve-01.vlab.local" -DDAuthTokenValue $DD_Token -verbose

    Get-DDAlert  -DDfqdn "ddve-01.vlab.local" -DDAuthTokenValue $DD_Token -activealert -epochtime

    Get-DDAlert  -DDfqdn "ddve-01.vlab.local" -DDAuthTokenValue $DD_Token -InfluxDBServer 'localhost' -InfluxDB 'DDALERT' -DDR 'DD4200' -DDLocation 'Hamburg' -DDserialno 'CKM0013370252' -add2InfluxDB epochtime

    Get-DDAlert  -DDfqdn "ddve-01.vlab.local" -DDAuthTokenValue $DD_Token -InfluxDBServer 'localhost' -InfluxDB 'DDALERT' -DDR 'DD4200' -DDLocation 'Hamburg' -DDserialno 'CKM0013370252' -dumpmeasurement
